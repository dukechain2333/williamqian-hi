...
export default function Bar() {
    return (
        <div
            ...
            <div
                className="2xl:w-1/2 2xl:left-auto 2xl:right-auto xl:w-2/3 xl:left-auto xl:right-auto lg:w-2/3 lg:left-auto lg:right-auto md:w-full md:align-middle text-white grid grid-cols-3 px-2 font-mono">
