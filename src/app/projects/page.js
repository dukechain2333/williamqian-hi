...
export default function Page() {
    ...
    return (
        <Content>
            <Bar/>
            <div className="mt-20 mb-10 2xl:w-1/2 2xl:left-auto 2xl:right-auto xl:w-2/3 xl:left-auto xl:right-auto lg:w-2/3 lg:left-auto lg:right-auto sm:w-full px-5">
