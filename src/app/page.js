...
export default function Home() {
    return (
        <Main>
            ...
            <span className="lg:mx-0 2xl:w-1/2 xl:w-2/3 lg:w-2/3 md:w-1/2 mx-2 w-auto my-8 animate-fade-in text-center text-gray-600 font-mono">
            ...
            <div className="grid 2xl:w-1/2 xl:w-2/3 lg:w-2/3 md:w-1/2 mb-32 text-center lg:mb-0 lg:grid-cols-3 lg:text-left animate-fade-in">
